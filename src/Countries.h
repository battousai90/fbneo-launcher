// src/Countries.h
//
// ISO 3166-1 alpha-2 codes and English names, generated once from the
// iso-codes package rather than read from it at runtime: the launcher ships
// as a flatpak, where that package is not guaranteed to be present, and a
